...
The default input is the final EDU06_R05.blend; --blend BUILD_DEBUG.blend is
...
parser.add_argument('--blend', default=str(ROOT / 'EDU06_R05.blend'))
...
scene = next(s for s in bpy.data.scenes if s.name.startswith('EDU06 R05 | Engineering'))
...
text('EDU06 / R05', 375, -329, 11, foot)
