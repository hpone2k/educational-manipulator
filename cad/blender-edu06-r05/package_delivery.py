...
names = '''EDU06_R05.blend README.md engineering-review.md assembled-preview.png base-detail.png
...
zip_path = ROOT/'EDU06_R05_Blender_and_Print_Prototype.zip'
with zipfile.ZipFile(zip_path,'w',compression=zipfile.ZIP_DEFLATED,compresslevel=6) as z:
    for name in names+['package-manifest.json']: z.write(ROOT/name,'EDU06_R05/'+name)
